...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var light = document.querySelector(".traffic-light__lamp");
    var redLight = document.querySelector('.red-color');
    var yellowLight = document.querySelector('.yellow-color');
    var greenLight = document.querySelector('.green-color');

    function activateTrafLight() {
        if (light.hasAttribute("disabled")) {
            var activateRed = function activateRed() {
                redLight.style.background = '#ff0000';
                yellowLight.style.background = 'transparent';
                greenLight.style.background = 'transparent';
            };

            var activateYellow = function activateYellow() {
                redLight.style.background = 'transparent';
                yellowLight.style.background = '#fff500';
                greenLight.style.background = 'transparent';
            };

            var activateGreen = function activateGreen() {
                redLight.style.background = 'transparent';
                yellowLight.style.background = 'transparent';
