...
function openTab() {
    var showTab = document.querySelector('#tabFirst');
    var showTab2 = document.querySelector('#tabSecond');
    var showTab3 = document.querySelector('#tabThird');
